...
public class EnemyEmitter {
    ...
    public EnemyEmitter(TextureAtlas atlas, Rect worldBounds, EnemyPool enemyPool) {
        ...
        enemySmallRegions = SplitRegions.split(atlas.findRegion("enemy0"), 1, 2, 2);
        enemyMediumRegions = SplitRegions.split(atlas.findRegion("enemy1"), 1, 2, 2);
        enemyBigRegions = SplitRegions.split(atlas.findRegion("enemy2"), 1, 2, 2);
    }
    ...
    public void generate(float delta) {
        ...
        if (generateTimer > GENERATE_INTERVAL) {
            ...
            enemyShip.position.x = MathUtils.random(
